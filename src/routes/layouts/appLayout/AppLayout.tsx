...
export function AppLayout() {
  ...
  return (
    <SidebarProvider>
      <AppSidebar />
      <section className=' w-full font-almari'>
        <div className='shadow-main h-[70px] flex items-center justify-between gap-5'>
          <Navbar />

          {/* --- Left Side --- */}
          <div className='text-primary text-8xl'>Twafok</div>
          <div className='left-side-container ml-[83.5px]'>
            <div className='working-hours flex'>
              <span className=''>متبقي على الدوم</span>
              <span>10:00:00</span>
            </div>
          </div>
        </div>
        ...
        <div className='grid grid-cols-12 grid-rows-12 mx-[38px] '>
