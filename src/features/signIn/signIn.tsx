      ...
      <div className='mt-[50px] bg-transparent  w-full max-w-sm flex flex-col items-center'>
        <form className='w-auto sm:w-[400px] space-y-[20px]' onSubmit={handleSubmit(onSubmit)}>
          <div>
            <input
              type='email'
              className='w-full py-[7px] px-[20px] font-almari text-[18px] bg-white text-[#BFBFBF] rounded-[12px] text-right focus:outline-none focus:ring-2 focus:ring-gray-500 transition duration-200'
          ...
          {/* <div className='text-left text-sm mt-2'>
            <a href='#' className=' hover:underline text-white text-[18px ] font-almari font-[300]'>
              نسيت كلمة المرور؟
            </a>
          </div> */}
